...
// Sidebar categories (static list display only)
const categories = [
    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <aside className={styles.sidebar}>
          {/* Category (Static List - display only) */}
          ...
          <p className={styles.priceInfo}>The highest price is $17,000.00</p>
          ...
          {/* Availability */}
          <h3 className={styles.sidebarTitle}>AVAILABILITY (1)</h3>
          <ul className={styles.categoryList}>
            <li>
              <input type="checkbox" id="in-stock" defaultChecked />
              <label htmlFor="in-stock">In stock <span>(13)</span></label>
            </li>
            <li>
              <input type="checkbox" id="out-of-stock" />
              <label htmlFor="out-of-stock">Out of stock <span>(2)</span></label>
            </li>
          </ul>
          ...
          <br/> <br/>
                  <img src="/promo-banner-collections_750x.png" alt="" />
          ...
          <div className={styles.topBar}>
            <div className={styles.viewControls}>
              <button
                ...
                className={view === "grid" ? styles.activeBtn : ""}
              >
                ⬛⬛
              </button>
              <button
                onClick={() => setView("list")}
                className={view === "list" ? styles.activeBtn : ""}
              >
                ☰
              </button>
            </div>
              ...
              <div className={styles.card} key={product.id}>
                <div className={styles.imageWrapper}>
                  ...
                  <div className={styles.socialIcons}>
                    <a href="" aria-label="add to cart" className={styles.icon}>
                      <PiTrolleyFill />
                    </a>
                    <a href="#" aria-label="wishlist" className={styles.icon}>
                      <FaHeart />
                    </a>
                  </div>
                </div>
